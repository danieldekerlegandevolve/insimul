...
const RuleSchema = new Schema({
  ...
  isCompiled: { type: Boolean, default: null },
  compiledOutput: { type: Schema.Types.Mixed, default: null },
...
const WorldSchema = new Schema({
  name: { type: String, required: true },
  description: { type: String, default: null },
  systemTypes: { type: Schema.Types.Mixed, default: null },
...
const ActionSchema = new Schema({
  ...
  prerequisites: { type: Schema.Types.Mixed, default: null },
  effects: { type: Schema.Types.Mixed, default: null },
  sideEffects: { type: Schema.Types.Mixed, default: null },
  targetType: { type: String, default: null },
  requiresTarget: { type: Boolean, default: null },
  range: { type: Number, default: null },
  isAvailable: { type: Boolean, default: null },
  cooldown: { type: Number, default: null },
  triggerConditions: { type: Schema.Types.Mixed, default: null },
  verbPast: { type: String, default: null },
  verbPresent: { type: String, default: null },
  narrativeTemplates: { type: Schema.Types.Mixed, default: null },
