 ...
 *
 * Also includes auto-generated world-type-specific grammars for all 20 standard world types.
 */

import { worldTypeGrammars } from './world-type-grammars.js';

export const seedGrammars = [
  // Auto-generated world type grammars (60 grammars: 3 per world type × 20 types)
  ...worldTypeGrammars,

  // Original Kismet grammars
  {
