/**
 * Example Insimul Rules
 * Demonstrates Insimul's rule format with conditions and effects.
 * These rules showcase personality-driven behavior, social dynamics,
 * and emergent gameplay from the simulation.
 */

export const insimulExampleRules = [
  // ============= EMPLOYMENT RULES =============
